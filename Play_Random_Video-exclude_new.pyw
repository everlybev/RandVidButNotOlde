...
def get_item_type(item):
    ...
    if item.__contains__('temp'):
        ...
        return 'exit'
    elif item.__contains__('\\h\\') and item.__contains__('\\new\\'):
        return 'exit'
...
get_item_type(hentai_destination)
...
if type_of_item == 'video':
    ...
    #current_folder = 'D:\\Videos\\Petto\\H\\Mimia Cute\\Lingerica_Dolls_Nana_demo\\'
    #travel down the folders and find a video
    while (type_of_item == 'folder' or type_of_item == 'exit'):
        try:
            ...
            if current_folder == hentai_destination:
                current_folder = hentai_location_after_watching
                selected_item = ''
            ...
            print(selected_item)
             ...
             current_folder = str(Path(current_folder).parents[1])
             selected_item = ''
        print('**')
        print(current_folder)
        print('**')
